...
const TOOLS = [
    ...
    },
    {
        ...
        description: "Take a screenshot of the current page or a specific element, if filePath is provided, the screenshot will be saved to the file path.",
        inputSchema: {
            type: "object",
            properties: {
                ...
                filePath: { type: "string", description: "File path to save the screenshot (optional)" },
            },
            required: ["name"],
        },
    },
            ...
            if (filePath) {
                ...
                return {
                    content: [
                        {
                            type: "text",
                            text: `Screenshot '${name}' taken at ${width}x${height}. File successfully saved to: ${filePath}`,
                        },
                    ],
                    isError: false,
                };
